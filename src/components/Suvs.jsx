  ...
  return (
    <section className="bg-green p-12">
          <img src={iconSuvs} alt="ícone dos carros suvs" className="mb-7" />
            ...
            <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-green border-2 border-offwhitebg
            hover:bg-green hover:text-offwhitebg" href="https://www.webmotors.com.br/sedans" target="_blank">Ver mais</a>
    </section>
  )
}
